...
and it serves as the rotation-prior convention oracle that the ``ours.flows``
odometry path is validated against. It will be removed once the live flow graph
is verified on the bench.
"""
